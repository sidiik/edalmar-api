...
let TicketService = TicketService_1 = class TicketService {
    ...
    constructor(prismaService, dbLoggerService, bookingService, agencyService, authService, messengerService) {
    ...
    async createTicket(data, metadata) {
        try {
            ...
            if (!booking) {
                ...
                throw new common_1.NotFoundException(ApiResponse_1.ApiResponse.failure(null, index_1.travelerErrors.bookingNotFound, common_1.HttpStatus.NOT_FOUND));
            }
